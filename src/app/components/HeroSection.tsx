...
export default function HeroSection() {
  ...
  return (
    ...
    >
      {/* Background elements */}
      <Image src="/assets/svgs/LeftEllipse.svg" alt="Left Ellipse" fill={false} width={300} height={300} className="absolute left-1/20 top-1/10" />
      <Image src="/assets/svgs/RightEllipse.svg" alt="" fill={false} width={300} height={300} className="absolute right-0 translate-x-1/3 top-1/10" />
      <Image src="/assets/svgs/Left.svg" alt="Left block" fill={false} width={400} height={400} className="absolute left-0 bottom-0 -translate-x-[28%] translate-y-[6%] w-[27vw] min-w-[200px]" />
      <Image src="/assets/svgs/right.svg" alt="Right block" fill={false} width={300} height={300} className="absolute right-0 bottom-0 translate-x-1/2 translate-y-1/10 w-[18vw] min-w-[150px]" />
